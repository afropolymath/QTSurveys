 ...
 * @property Brand_model $brand_model    User Defined model
 * @property Question_model $question_model    User Defined model
 * @property Survey_model $survey_model    User Defined model
 */
class CI_Controller{}
